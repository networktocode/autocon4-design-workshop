...
1\. In the VSCode window with "autocon4-design-workshop" opened, expand on the "jobs" folder
...
8\. Lets run this Job. Go to Nautobot in your Browser. Click "Jobs"
...
10\. Click the play button next to "Simple Design" to run the Job.
...
15\. This is the detail view of the Cisco Manufacturer object! What if we run the design again though? To find out what happens, click "Jobs"
...
16\. Click the play button next to "Simple Design" to run the Job a second time.
...
22\. Save your changes and go to the "Source Control" tab in the right navbar in VSCode
...
38\. Type a commit message (ie "Added Platform and locations") and click on "Commit"
...
40\. Let's sync these latest changes into Nautobot. Click "Extensibility"
